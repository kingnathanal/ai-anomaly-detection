# Copilot Instructions — Edge AI Latency Anomaly Detection Testbed
...
any issues that arise during development or deployment should be documented in `docs/troubleshooting-log.md` with clear instructions for troubleshooting and recovery.